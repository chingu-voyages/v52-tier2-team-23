...
function FilterSection({ onCloseFilterModal }) {
  //Close Filter modal
  const [isFilterModalClosed, setFilterModalClosed] = useState(true);
  const handleCloseFilterModal = () => {
    setFilterModalClosed(true);
    onCloseFilterModal();
  };
  return (
    <>
